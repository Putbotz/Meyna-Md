...
global.owner.push(['628816609112'])
...
exports.makeWASocket = (connectionOptions, options = {}) => {
  ...
  /**
    ...
    */
    ...
    conn.adReply = (jid, text, title = '', body = '', buffer, source = '', quoted, options) => {
...
`.trim()
      ...
      conn.sendList = async (jid, header, footer, separate, buttons, rows, quoted, options) => {
    ...
    conn.reply = (jid, text = '', quoted, options) => {
        return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, mentions: conn.parseMention(text) }, { quoted, ...options, mentions: conn.parseMention(text) })
    }
...
conn.sendPoll = async (jid, name = '', values = [], quoted, selectableCount = 1, options = {}) => { return conn.sendMessage(jid, { poll: { name, values, selectableCount }, options }, { quoted: quoted })}
...
/*exports.smsg = (conn, m, hasParent) => {
     ...
     * @param {Object} options
     */
    m.reply = async (text, chatId, options) => conn.reply(chatId ? chatId : m.chat, text, m, options, {
     contextInfo: {
      isForwarded: true,
      forwardedNewsletterMessageInfo: {
        newsletterJid: '120363288101737637@newsletter',
        newsletterName: 'Kiku.Ai ✧˖°',
        serverMessageId: -1
      },
    }
  })
